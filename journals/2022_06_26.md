...
- Deber de Planificación
	- Estrategias  FO, se deben crear estrategias que usen fortalezas para aprovechar  las oportunidades
		- FACTORES TECNOLOGICOS
		  ...
		  Con la información de los párrafos anteriores crear 3 estrategias que aprovechen las Fortalezas para evitar las Amenazas:
			- 1. Aprovechar la ubicación estratégica del cantón y potenciar el turismo. 
			  2. Impulsar campañas de sensibilización sobre la importancia de la tecnología y fomentar su uso.
			  3. Mejorar la calidad de la señal de televisión y aumentar la cobertura de internet.
